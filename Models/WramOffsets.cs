...
using ChunkSizes = RosettaStone.Sram.SoE.Models.SramSizes.SaveSlot;
...
namespace RosettaStone.Savestate.Snes9x.SoE.Models
{
	...
	public class WramOffsets
	{
		...
		public class Sram
		{
			...
			{
				[Chunk1] = (38, ChunkSizes.Chunk1), // [x26]

				[Chunk2] = (110, ChunkSizes.Chunk2), // [x6E] (2)
				[Chunk3] = (112, ChunkSizes.Chunk3), // [x70] (24)
				[Chunk4] = (136, ChunkSizes.Chunk4), // [x88] (6)
				[Chunk5] = (142, ChunkSizes.Chunk5), // [x8E] (2)
				[Chunk6] = (144, ChunkSizes.Chunk6), // [x90] (13) 
				[Chunk7] = (157, ChunkSizes.Chunk7), // [x9D] (4)
				[Chunk8] = (161, ChunkSizes.Chunk8), // [xA1] (14)

				[Chunk9] = (175, ChunkSizes.Chunk9), // [xAF] (2)
			...
			public const int Chunk5 = 2613; // [xA35] (2 bytes)
			public const int Chunk6 = 2623; // [xA3F] (13 bytes)
			public const int Chunk7 = 2640; // [xA50] (4 bytes)
			...
			public const int Chunk2 = 20147; // [x4EB3] (2 bytes)
			public const int Chunk3 = 20175; // [x4ECF] (24 bytes)

			public const int Chunk4 = 20259; // [x4F23] (6 bytes)
			public const int Chunk8 = 20265; // [x4F29] (14 bytes)
			public const int Chunk9 = 20321; // [x4F61] (2 bytes)
